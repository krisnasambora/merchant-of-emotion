	...
	<body>
		...
		<div class="container-fluid padding-0">
			<div class="col-md-6 col-md-offset-3 text-justify padipay-info">
			    ...
			    <p><b>Finpay</b></p>
			    <ul>
			    	<li>Pembayaran dengan menu pembayaran telepon untuk seluruh bank di Indonesia dan untuk ATM, <i>Internet Banking</i>, dan <i>Mobile Banking</i> (kecuali ATM Mandiri).</li>
			    	<li>Anda dikenakan <i>administration fee</i> sebesar IDR 5.000 saat nominal akhir transaksi, dan otomatis IDR 2.500 sebagai biaya transfer.</li>
			    	<li>Tata cara pembayaran tercantum di halaman pembayaran.</li>
			    </ul>
			    <p><b>Indomaret dan Alfamart</b></p>
			    <ul>
			    	<li>Pembayaran dengan <i>drop cash</i> di Indomaret dan Alfamart.</li>
			    	<li>Anda dikenakan administration fee sebesar IDR 5.000 saat nominal akhir transaksi.</li>
			    	<li>Tata cara pembayaran tercantum di halaman pembayaran.</li>
			    </ul>
			    <p><b>Mitrapay (ATM, iBanking, dan <i>Mobile Banking</i> Mandiri)</b></p>
			    <ul>
			    	<li>Pembayaran dengan menu Pembayaran Lain Lain via Mitrapay 70009 untuk ATM, <i>Internet Banking</i>, dan <i>Mobile Banking</i> Bank Mandiri</li>
			    	<li>Anda dikenakan administration fee sebesar IDR 5.000 saat nominal akhir transaksi.</li>
			    	<li>Tata cara pembayaran tercantum di halaman pembayaran.</li>
			    </ul>
			    ...
			    <a href="https://padipay.com/sunset-deity/">
			    	<h2 class="text-center back-button"><b>Get Tickets!</b></h2>
			    </a>
			</div>
			<div class="col-xs-12 text-center bottom-border">
			    <img src="{{asset('images/sunset/the-beginning-of-sunset-deity-tickets-new/header/border.png')}}" class="center-block img-responsive">
			</div>
		</div>
	</body>
