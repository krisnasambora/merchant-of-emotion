    	...
    	<div class="container-fluid">
			<div class="col-xs-10 col-xs-offset-1">
				...
				<ul class="nav nav-tabs" role="tablist">
				    <li role="presentation" class="active"><a href="#tab-seats" aria-controls="tab-seats" role="tab" data-toggle="tab">Seats</a></li>
				    <li role="presentation"><a href="#tab-pending" aria-controls="tab-pending" role="tab" data-toggle="tab">Pending</a></li>
				    <li role="presentation"><a href="#tab-confirmed" aria-controls="tab-confirmed" role="tab" data-toggle="tab">Confirmed</a></li>
			    </ul>
			    <div class="tab-content">
			    	<div role="tabpanel" class="tab-pane active" id="tab-seats">
						<h4>Seats</h4>
					...
					<div role="tabpanel" class="tab-pane" id="tab-confirmed">
