...
@section('content')
	...
	<div class="front scroll">
		...
		<div class="element06 page">
			<a href="http://merchantofemotion.com/the-beginning-of-sunset-deity/announcement"><img alt="" src="{{asset('images/sunset/the-beginning-of-sunset-deity-01/next.png')}}"></a>
		</div>
	</div>
@stop
