<html>
    <body style="font-family: Courier New;">
        ...
        <p align="right">Kode Pemesanan</p>
        <div class="box"style="float: right; width:150px; height:70px;border-style: solid; border-width: 1px;">
            <p align="center" style="font-size:25px;font-weight:bold;"> 0021 </p>
        </div>
        <p>Nama        :  cobol </p>
        <p>No Telepon  :  cobol </p>
        <p>Email       :  cobol </p>
        <p>No ID       :  cobol </p><br/>
        <div style="margin-left: 35%;text-align:center;width:400px;height:360px;">
            ...
            <div class="box"style="margin-left:32%;width:140px; height:110px;border-style: solid; border-width: 1px;">
                <p align="center" style="font-size:25px;font-weight:bold;"> si cobol </p>
            </div>
            <br/>
            <br/>
